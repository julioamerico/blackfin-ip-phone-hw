...
#define CONFIG_BFIN_BOOT_MODE       BFIN_BOOT_UART/*BFIN_BOOT_SPI_MASTER*/
 ...
 *
 *	Environment variables stored in 3rd sector of S25FL064P.
 *	The sector size is 64 kB except for the two first sectors.
 *  This U-Boot version doesn't	support 4kB subsector erase.
 *  That's why the 3rd sector must be used exclusively for
 *  this purpose.
*/
#define CONFIG_ENV_IS_IN_SPI_FLASH
